...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{photos/AWS}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{photos/experiment}
...
\begin{figure*}
	...
	\caption{Changes in the msuclemuscle activation pattern of the gait cycle due to the use of AWGAS with standard deviation. The Xx- axis signifies the gait cycle from 0 to 100 \% and the Y- axis signifies the average \%MVC sEMG activation pattern for each muscle under observation}
	\label{fig:emgenvelope}
\end{figure*}
\begin{figure*}
	\centering
	\includegraphics[width=1\linewidth]{photos/AWGASemgbarpvalue}
