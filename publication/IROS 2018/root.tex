...
In this paper we discussed the improved design and control of Augmented Walking Suit by keeping human locomotion in loop by using gait cycle identification mechanism for generating assistive force. In section \ref{methodology} PGM and its force characteristics, biomechanics and human gait detection system and design and configuration of the Augmented walking suit is discussed. In section \ref{Evaluation} we discuss about the evaluation criteria, experiment method setups, results of the lower limb sEMG evaluation for different force levels with comparison of average gait sEMG envelop for all subjects and statistical analysis. Section \ref{discuss} depicts the discussion, conclusion and future works. 
